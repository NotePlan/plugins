# GenAITaskChecker Noteplan Plugin

## Latest Updates

See [CHANGELOG](https://github.com/NotePlan/plugins/blob/main/mlevison.GenAITaskChecker/CHANGELOG.md) for latest updates/changes to this plugin.

## About This Plugin 

Finds all tasks in the current note and submits them the LLM asking if the tasks are aligned with quarterly plan.
