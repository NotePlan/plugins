...
declare class HTMLView {
  ...
  *   - icon: string - FontAwesome icon string for the navigation bar. Note: currently doesn't support setting the font type, and always uses "fa-regular". Needs to be the full name, so will include the "fa-" prefix.
