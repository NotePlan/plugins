// flow-typed signature: e7b8edb494eb72c1ed74d7c62416ef20
// flow-typed version: 179ae71d58/lodash_v4.x.x/flow_>=v0.104.x <=v0.152.x
...
declare module 'lodash' {
  ...
  declare var Lodash: LodashObj
  declare type LodashObj = $ReadOnly<{
    // Array
    ...
    pullAllBy<T: void | null>(array: T, values?: ?$ReadOnlyArray<any>, iteratee?: ?ValueOnlyIteratee<any>): T,
    ...
    find<R, A, T: ReadOnlyIndexerObject<A>>(object: T, predicate?: ?OPredicate<A, T>, fromIndex?: ?number): R,
    ...
    findLast<R, A, T: ReadOnlyIndexerObject<A>>(object: T, predicate?: ?OPredicate<A, T>, fromIndex?: ?number): R,
    flatMap<A, U, T: $ReadOnlyArray<A> = Array<A>>(array: T, iteratee?: ?AFlatMapIteratee<A, T, U>): Array<U>,
    flatMap<A, K, U, T: ?ReadOnlyIndexerObject<A, K> | string = IndexerObject<A, K>>(object: T, iteratee?: ?OFlatMapIteratee<A, K, T, U>): Array<U>,
    flatMapDeep<A, U, T: $ReadOnlyArray<A> = Array<A>>(array: T, iteratee?: ?AFlatMapIteratee<A, T, any>): Array<U>,
    flatMapDeep<A, K, U, T: ?ReadOnlyIndexerObject<A, K> | string = IndexerObject<A, K>>(object: T, iteratee?: ?OFlatMapIteratee<A, K, T, any>): Array<U>,
    flatMapDepth<A, U, T: $ReadOnlyArray<A> = Array<A>>(array: T, iteratee?: ?AFlatMapIteratee<A, T, any>, depth?: ?number): Array<U>,
    flatMapDepth<A, K, U, T: ?ReadOnlyIndexerObject<A, K> | string = IndexerObject<A, K>>(object: T, iteratee?: ?OFlatMapIteratee<A, K, T, any>, depth?: ?number): Array<U>,
    ...
    groupBy<V, A, T: ReadOnlyIndexerObject<A>>(object: T, iteratee?: ValueOnlyIteratee<A>): { [key: V]: Array<A>, ... },
    ...
    invokeMap<A>(object: ReadOnlyIndexerObject<A>, path: ((value: any) => Path) | Path, ...args?: $ReadOnlyArray<any>): Array<any>,
    keyBy<T, V>(array: $ReadOnlyArray<T>, iteratee?: ?ValueOnlyIteratee<T>): { [key: V]: T, ... },
    keyBy(array: void | null, iteratee?: ?ValueOnlyIteratee<*>): { ... },
    keyBy<V, A, K, T: ReadOnlyIndexerObject<A, K>>(object: T, iteratee?: ?ValueOnlyIteratee<A>): { [key: V]: A, ... },
    ...
    orderBy<V, T: ReadOnlyIndexerObject<V>>(object: T, iteratees?: $ReadOnlyArray<OIteratee<*>> | string, orders?: $ReadOnlyArray<'asc' | 'desc'> | string): Array<V>,
    partition<T>(array?: ?$ReadOnlyArray<T>, predicate?: ?Predicate<T>): [Array<T>, Array<T>],
    partition<V, A, T: ReadOnlyIndexerObject<A>>(object: T, predicate?: OPredicate<A, T>): [Array<V>, Array<V>],
    reduce<T, U>(array: $ReadOnlyArray<T>, iteratee?: (accumulator: U, value: T, index: number, array: ?Array<T>) => U, accumulator?: U): U,
    reduce<T, U>(array: void | null, iteratee?: ?(accumulator: U, value: T, index: any, array: ?Array<T>) => U, accumulator?: U): U,
    reduce<A, T: ReadOnlyIndexerObject<A>, U>(object: T, iteratee?: (accumulator: U, value: any, key: string, object: T) => U, accumulator?: U): U,
    ...
    reduceRight<A, T: ReadOnlyIndexerObject<A>, U>(object: T, iteratee?: ?(accumulator: U, value: any, key: string, object: T) => U, accumulator?: ?U): U,
    ...
    sortBy<T>(array: ?$ReadOnlyArray<T>, iteratees?: $ReadOnlyArray<Iteratee<T>>): Array<T>,
    sortBy<V, T: ReadOnlyIndexerObject<V>>(object: T, ...iteratees?: $ReadOnlyArray<OIteratee<T>>): Array<V>,
    sortBy<V, T: ReadOnlyIndexerObject<V>>(object: T, iteratees?: $ReadOnlyArray<OIteratee<T>>): Array<V>,
    ...
    findKey<A, T: ReadOnlyIndexerObject<A>>(object: void | null, predicate?: ?OPredicate<A, T>): void,
    findLastKey<A, T: ReadOnlyIndexerObject<A>>(object: T, predicate?: ?OPredicate<A, T>): string | void,
    findLastKey<A, T: ReadOnlyIndexerObject<A>>(object: void | null, predicate?: ?OPredicate<A, T>): void,
    ...
    keys<Obj: { ... }>(object?: Obj): Array<$Keys<Obj>>,
  ...
  declare module.exports: LodashObj
}
...
declare module 'lodash/fp' {
  ...
  declare var Lodash: LodashFPObj
  declare type LodashFPObj = $ReadOnly<{
    // Array
    ...
    differenceBy<T>(iteratee: ValueOnlyIteratee<T>, values: $ReadOnlyArray<T>): (array: $ReadOnlyArray<T>) => Array<T>,
    differenceBy<T>(iteratee: ValueOnlyIteratee<T>, values: $ReadOnlyArray<T>, array: $ReadOnlyArray<T>): Array<T>,
    differenceWith<T>(
      comparator: Comparator<T>,
    ): ((first: $ReadOnlyArray<T>) => (second: $ReadOnlyArray<T>) => Array<T>) & ((first: $ReadOnlyArray<T>, second: $ReadOnlyArray<T>) => Array<T>),
    differenceWith<T>(comparator: Comparator<T>, first: $ReadOnlyArray<T>): (second: $ReadOnlyArray<T>) => Array<T>,
    differenceWith<T>(comparator: Comparator<T>, first: $ReadOnlyArray<T>, second: $ReadOnlyArray<T>): Array<T>,
    ...
    intersectionBy<T>(iteratee: ValueOnlyIteratee<T>, a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>): Array<T>,
    intersectionWith<T>(comparator: Comparator<T>): ((a1: $ReadOnlyArray<T>) => (a2: $ReadOnlyArray<T>) => Array<T>) & ((a1: $ReadOnlyArray<T>, a2: $ReadOnlyArray<T>) => Array<T>),
    ...
    pullAll<T>(values: $ReadOnlyArray<T>, array: Array<T>): Array<T>,
    pullAllBy<T>(iteratee: ValueOnlyIteratee<T>): ((values: $ReadOnlyArray<T>) => (array: Array<T>) => Array<T>) & ((values: $ReadOnlyArray<T>, array: Array<T>) => Array<T>),
    pullAllBy<T>(iteratee: ValueOnlyIteratee<T>, values: $ReadOnlyArray<T>): (array: Array<T>) => Array<T>,
    pullAllBy<T>(iteratee: ValueOnlyIteratee<T>, values: $ReadOnlyArray<T>, array: Array<T>): Array<T>,
    ...
    findFrom<T>(predicate: Predicate<T> | OPredicate<T>, fromIndex: number): (collection: Collection<T>) => T | void,
    findFrom<T>(predicate: Predicate<T> | OPredicate<T>, fromIndex: number, collection: Collection<T>): T | void,
    ...
    findLastFrom<T>(predicate: Predicate<T> | OPredicate<T>, fromIndex: number): (collection: Collection<T>) => T | void,
    findLastFrom<T>(predicate: Predicate<T> | OPredicate<T>, fromIndex: number, collection: Collection<T>): T | void,
    ...
    flatMapDepth<T, U>(iteratee: AFlatMapIteratee<T, U> | OFlatMapIteratee<T, U>, depth: number): (collection: Collection<T>) => Array<U>,
    flatMapDepth<T, U>(iteratee: AFlatMapIteratee<T, U> | OFlatMapIteratee<T, U>, depth: number, collection: Collection<T>): Array<U>,
    ...
    includesFrom(value: string, fromIndex: number, str: string): boolean,
    includesFrom<T>(value: T): ((fromIndex: number) => (collection: $ReadOnlyArray<T>) => boolean) & ((fromIndex: number, collection: $ReadOnlyArray<T>) => boolean),
    ...
    invokeArgsMap<T>(path: ((value: T) => Path) | Path, collection: Collection<T>): (args: $ReadOnlyArray<any>) => Array<any>,
    invokeArgsMap<T>(path: ((value: T) => Path) | Path, collection: Collection<T>, args: $ReadOnlyArray<any>): Array<any>,
    ...
    orderBy<T>(
      ...
      ((orders: $ReadOnlyArray<'asc' | 'desc'> | string, collection: Collection<T>) => Array<T>),
    orderBy<T>(iteratees: $ReadOnlyArray<Iteratee<T> | OIteratee<*>> | string, orders: $ReadOnlyArray<'asc' | 'desc'> | string): (collection: Collection<T>) => Array<T>,
    orderBy<T>(iteratees: $ReadOnlyArray<Iteratee<T> | OIteratee<*>> | string, orders: $ReadOnlyArray<'asc' | 'desc'> | string, collection: Collection<T>): Array<T>,
    ...
    reduce<T, U>(iteratee: (accumulator: U, value: T) => U, accumulator: U): (collection: Collection<T>) => U,
    reduce<T, U>(iteratee: (accumulator: U, value: T) => U, accumulator: U, collection: Collection<T>): U,
    reduceRight<T, U>(iteratee: (value: T, accumulator: U) => U): ((accumulator: U) => (collection: Collection<T>) => U) & ((accumulator: U, collection: Collection<T>) => U),
    reduceRight<T, U>(iteratee: (value: T, accumulator: U) => U, accumulator: U): (collection: Collection<T>) => U,
    reduceRight<T, U>(iteratee: (value: T, accumulator: U) => U, accumulator: U, collection: Collection<T>): U,
  ...
  declare module.exports: LodashFPObj
}
