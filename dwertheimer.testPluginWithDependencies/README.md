# deleteme Noteplan Plugin

## Latest Updates

See [CHANGELOG](https://github.com/NotePlan/plugins/blob/main/dwertheimer.deleteme/CHANGELOG.md) for latest updates/changes to this plugin.
