# hiddenTest2  Noteplan Plugin

## Latest Updates

See [CHANGELOG](https://github.com/NotePlan/plugins/blob/main/dwertheimer.hiddenTest2/CHANGELOG.md) for latest updates/changes to this plugin.
