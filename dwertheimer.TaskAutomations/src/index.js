// @flow
export { default as sortTasks, sortTasksByPerson, sortTasksByTag, tasksToTop, openTasksToTop, sortTasksViaTemplate, sortTasksTagMention, sortTasksDefault } from './sortTasks'
