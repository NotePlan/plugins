...
- **README:** Document how combined vs traditional task grouping interacts with type headings (sort vs write behavior, including block concat when headings are on).
