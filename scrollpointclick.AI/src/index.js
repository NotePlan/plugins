...
export { testConnection, createAIImages, createResearchRequest, createResearchListRequest, createQuickSearch, summarizeNote, introWizard, helpWizard, updateREADME } from './NPAI' // add one of these for every command specifified in plugin.json (the function could be in any file as long as it's exported)
