    ...
    const section: TSection = {
      ...
      actionButtons: [
        ...
        },
        {
          ...
          display: '<i class= "fa-regular fa-fw  fa-circle-arrow-right MonthlyColor" ></i> ',
        ...
        },
        {
          ...
          display: '<i class= "fa-regular fa-fw  fa-square-arrow-right MonthlyColor" ></i> ',
          actionParam: nextPeriodFilename,
          formFields: nextMonthFormFields,
          submitOnEnter: true,
          submitButtonText: 'Add & Close',
    ...
    const section: TSection = {
      ...
      actionButtons: [
        ...
        },
        {
          ...
          display: '<i class= "fa-regular fa-fw  fa-circle-arrow-right QuarterlyColor" ></i> ',
          actionParam: nextPeriodFilename,
        ...
        },
        {
          ...
          display: '<i class= "fa-regular fa-fw  fa-square-arrow-right QuarterlyColor" ></i> ',
          actionParam: nextPeriodFilename,
          formFields: nextQuarterFormFields,
          submitOnEnter: true,
          submitButtonText: 'Add & Close',
    ...
    const section: TSection = {
      ...
      actionButtons: [
        ...
        },
        {
          ...
          display: '<i class= "fa-regular fa-fw  fa-circle-arrow-right YearlyColor" ></i> ',
          actionParam: nextPeriodFilename,
        ...
        },
        {
          ...
          display: '<i class= "fa-regular fa-fw  fa-square-arrow-right YearlyColor" ></i> ',
          actionParam: nextPeriodFilename,
          formFields: nextYearFormFields,
          submitOnEnter: true,
          submitButtonText: 'Add & Close',
