...
export const openWeekParas: Array<TSectionItem> = [
  ...
  // $FlowIgnore[prop-missing] ID gets added later
  {
    ...
    para: {
      ...
      filename: thisFilename,
      lineIndex: 22,
      content: '@church Get iPad working on staff wifi for Drive, Printing @office ^bzlp1z',
      rawContent: '@church Get iPad working on staff wifi for Drive, Printing @office ^bzlp1z',
      blockId: '^bzlp1z',
      priority: 0,
      prefix: '* ',
      changedDate: new Date('2023-02-27T00:00:00.000Z'),
