...
export const openTodayItems: Array<TSectionItem> = [
  {
    ...
    para: {
      ...
      title: thisDateStr,
      priority: 0,
      content: 'Longer timeblocked task at 10:00-16:30',
      rawContent: 'Longer timeblocked task at 10:00-16:30',
      prefix: '* ',
      indents: 0,
    },
  },
  {
    ...
    para: {
      ...
      lineIndex: 2,
      priority: 1,
      content: 'Reconcile bank statement @repeat(1m) at 20:00-21:00',
      rawContent: 'Reconcile bank statement @repeat(1m) at 20:00-21:00',
      prefix: '* ',
      indents: 0,
    },
  },
...
export const refTodayItems: Array<TSectionItem> = [
  ...
  },
  {
    ...
    para: {
      ...
      priority: 2,
      prefix: '* ',
      content: '!! Respond from last 2 meetings >today #win',
      rawContent: '!! Respond from last 2 meetings >today #win',
      blockId: '^wazhht',
      hasChild: true,
      indents: 0,
    },
  ...
  items: [
    ...
    },
    {
      ...
      para: {
        ...
        prefix: '* ',
        hasChild: true,
        children: (): $ReadOnlyArray<any> => [{ content: 'check contract with Bev', indents: 1 }],
        indents: 0,
      },
    },
    {
      ...
      para: {
        ...
        priority: 0,
        hasChild: true,
        children: (): $ReadOnlyArray<any> => [{ content: 'plan Something Different for 5/3', indents: 1 }],
        indents: 0,
      },
    },
  ]
