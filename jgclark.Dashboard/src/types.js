...
export type TActionOnReturn =
  ...
  | 'ACTIVE_PERSPECTIVE_DEFINITION_CHANGED'
...
export type TPluginData = {
  ...
  perspectiveChanging?: boolean /* true while switching perspective (blocks settings sync-back; UI uses firstRun "Generating" on RefreshControl) */,
  ...
  /**
   * Hidden demo/screenshot helper: when set (e.g. `REM-3`), React opens the matching item dialog then clears this field.
   */
  openDialogForItemID?: string,
