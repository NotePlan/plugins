...
const featureFlagSettingDefs = [
  ...
  { key: 'FFlag_ShowSectionTimings', label: 'Show timings in Section', description: 'Show generation timings in section headers for non-calendar sections' },
  { key: 'FFlag_UseTagCache', label: 'Use Tag Cache', description: 'Use tag cache to speed up tag/mention searches' },
  { key: 'FFlag_TagCacheOnlyForOpenItems', label: 'Tag Cache only for open items', description: 'Tag Cache only tracks open tasks/checklists. Need to issue /generateTagMentionCache after changing this setting.' },
]
