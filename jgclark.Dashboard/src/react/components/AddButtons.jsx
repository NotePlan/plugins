...
const AddButtons = (): React$Node => {
  ...
  return (
    <>
      ...
      >
        <i className="fa-regular fa-fw fa-circle-plus DailyColor"></i>
      </button>
      <button
        className="XCBButton tooltip"
      ...
      >
        <i className="fa-regular fa-fw fa-square-plus DailyColor"></i>
      </button>{' '}
      <button
        className="XCBButton tooltip"
      ...
      >
        <i className="fa-regular fa-fw fa-circle-arrow-right DailyColor"></i>
      </button>{' '}
      <button
        className="XCBButton tooltip"
      ...
      >
        <i className="fa-regular fa-fw fa-square-arrow-right DailyColor"></i>
      </button>
    </>
  )
}
