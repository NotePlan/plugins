...
- `{{affirmation()}}` or `{{affirmation(true)}}` - get a random affirmation from [Affirmations.dev](https://www.affirmations.dev/) or set it to true and get a random configured affirmation
