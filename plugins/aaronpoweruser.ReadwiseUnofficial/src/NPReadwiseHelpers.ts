...
import { logDebug } from '@np/helpers/dev'
...
export function buildReadwiseFrontMatter(source: any): any {
  const frontMatter = {}
  // @ts-ignore - intentionally setting properties dynamically as frontMatter keys are dynamic
  ...
  if (source.unique_url !== null) {
    // @ts-ignore - we are intentionally setting properties dynamically
