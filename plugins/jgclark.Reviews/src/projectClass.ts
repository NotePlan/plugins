...
import { localeRelativeDateFromNumber } from '@np/helpers/NPdateTime'
import { clo, JSP, logDebug, logError, logInfo, logTimer, logWarn } from '@np/helpers/dev'
import { getFolderFromFilename } from '@np/helpers/folders'
import { createOpenOrDeleteNoteCallbackUrl, getContentFromBrackets, getStringFromList } from '@np/helpers/general'
import {
  makeSVGPercentRing,
  redToGreenInterpolation,
} from '@np/helpers/HTMLView'
import { removeAllDueDates } from '@np/helpers/NPParagraph'
import { findStartOfActivePartOfNote, simplifyRawContent } from '@np/helpers/paragraph'
import { getLineMainContentPos } from '@np/helpers/search'
import { encodeRFC3986URIComponent } from '@np/helpers/stringTransforms'
import {
  getInputTrimmed,
  inputIntegerBounded,
} from '@np/helpers/userInput'
import { isDone, isOpen } from '@np/helpers/utils'
