...
import { logDebug, logError, logWarn, clo, JSP } from '@np/helpers/dev'
import { createPrettyRunPluginLink, parseJSON5 } from '@np/helpers/general'
import { removeContentUnderHeading } from '@np/helpers/NPParagraph'
import { chooseOption } from '@np/helpers/userInput'
 ...
 */
export function scrollToEntry(_heading: string, _deleteItem?: null | void | string = null, foldHeading?: null | void | string = null): void {
  try {
    const heading =
