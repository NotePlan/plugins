...
import { getDateStringFromCalendarFilename, getTodaysDateHyphenated, getTodaysDateUnhyphenated, filenameIsInFuture, includesScheduledFutureDate } from '@np/helpers/dateTime'
    ...
    if (useDemoData) {
      ...
      sortedItems.map((item) => {
        if (item.para) {
          ...
          // @ts-ignore already checked item.para exists
