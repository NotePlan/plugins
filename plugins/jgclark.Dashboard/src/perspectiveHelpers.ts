...
import { clo, clof, JSP, logDebug, logError, logInfo, logWarn } from '@np/helpers/dev'
import { getFoldersMatching } from '@np/helpers/folders'
import { chooseOption, getInputTrimmed, showMessage } from '@np/helpers/userInput'
...
export async function updateCurrentPerspectiveDef(): Promise<boolean> {
  try {
    ...
    // @ts-ignore // doesn't like the partial settings
