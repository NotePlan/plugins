...
import { clo, clof, logDebug } from '@np/helpers/react/reactDev'
...
export const createDashboardSettingsItems = (allSettings: TAnyObject, _pluginSettings: any): Array<object> => {
  return dashboardSettingDefs.map((setting) => {
    ...
    switch (setting.type) {
      ...
      // @ts-ignoredon't understand the error
