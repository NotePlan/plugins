...
import { clo, logDebug, logError } from '@np/helpers/react/reactDev.js'
...
const PerspectiveSettings = ({ handleFieldChange, className = '' }: PerspectiveSettingsProps): React.ReactNode => {
  try {
    //----------------------------------------------------------------------
    // Context
    //----------------------------------------------------------------------
