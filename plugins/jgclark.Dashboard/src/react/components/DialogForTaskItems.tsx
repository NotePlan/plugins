...
import { clo, clof, JSP, logDebug, logInfo } from '@np/helpers/react/reactDev'
import EditableInput from '@np/helpers/react/EditableInput.jsx'
...
const DialogForTaskItems = ({ details: detailsMessageObject, onClose, positionDialog }: Props): React.ReactNode => {
