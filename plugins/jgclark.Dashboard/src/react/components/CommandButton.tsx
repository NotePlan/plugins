...
import { showDialog } from '@np/helpers/react/userInput'
import { logDebug, JSP, clo } from '@np/helpers/react/reactDev.js'
type ButtonProps = {
...
function CommandButton(inputObj: ButtonProps): React.ReactNode {
