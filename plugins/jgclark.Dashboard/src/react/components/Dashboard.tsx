...
import { clo, clof, JSP, logDebug, logError, logInfo } from '@np/helpers/react/reactDev.js'
import '../css/Dashboard.css'
import DebugPanel from '@np/helpers/react/DebugPanel'
...
//--------------------------------------------------------------------------
const Dashboard = ({ pluginData }: Props): React.ReactNode => {
  //----------------------------------------------------------------------
  // Context
  //----------------------------------------------------------------------
