...
import { ThemedSelect, type OptionType } from '@np/helpers/react/ThemedSelect'
...
const ThemedComboBox = ({ label, description = '', options, value, onChange, onSelect, inputRef, compactDisplay, defaultValue }: ComboBoxProps): React.ReactNode => {
