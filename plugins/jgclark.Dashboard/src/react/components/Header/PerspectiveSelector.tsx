...
import { clo, logDebug, logWarn, logError } from '@np/helpers/react/reactDev.js'
import { showDialog, showConfirmationDialog } from '@np/helpers/react/userInput'
import { compareObjects, dt } from '@np/helpers/dev.js'
...
//--------------------------------------------------------------------------
const PerspectiveSelector = (): React.ReactNode => {
  //----------------------------------------------------------------------
  // Context
  //----------------------------------------------------------------------
