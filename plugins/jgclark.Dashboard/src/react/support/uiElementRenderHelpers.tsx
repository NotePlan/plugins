...
import PerspectiveSettings from '../components/PerspectiveSettings.js'
import type { TSettingItem, TPerspectiveDef } from '../../types'
import { logDebug, logError } from '@np/helpers/react/reactDev'
...
export function renderItem({
  ...
  const element = () => {
    ...
    switch (item.type) {
      ...
      // @ts-ignoredon't understand this
