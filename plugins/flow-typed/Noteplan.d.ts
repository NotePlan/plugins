...
declare interface TEditor extends CoreNoteFields {
   ...
   */
  selection: null | undefined | Range;
  /**
   * Get the rendered selection range (hidden Markdown is NOT considered).
   */
  renderedSelection: null | undefined | Range;
  /**
   * Get the selected text.
   */
  selectedText: null | undefined | string;
   ...
   * @param {Float?}
   */
  showLoading(visible: boolean, text?: null | undefined | string, progress?: number): void;
  /**
 ...
 */
type TDataStore = typeof DataStore;
...
declare class DataStore {
   ...
   */
  static preference: (key: string) => unknown;
  /**
   ...
   * @returns {string?}
   */
  static loadData(filename: string, loadAsString: boolean): null | undefined | string;
  /**
   ...
   * @returns {NoteObject}
   */
  static calendarNoteByDate(date: Date, timeframe?: string): null | undefined | TNote;
  /**
   ...
   * Note: In response to questions about yet-to-exist future dates, @EM says "The file gets created when you assign content to a future, non-existing note." In this situation when this call is made, note.content will be never.
   * @param {string}
   * @returns {NoteObject}
   */
  static calendarNoteByDateString(dateString: string): null | undefined | TNote;
  /**
   ...
   */
  static projectNoteByTitle(title: string, caseInsensitive?: boolean, searchAllFolders?: boolean): null | undefined | ReadonlyArray<TNote>;
  /**
   ...
   */
  static projectNoteByTitleCaseInsensitive(title: string): null | undefined | ReadonlyArray<TNote>;
  /**
   ...
   */
  static projectNoteByFilename(filename: string): null | undefined | TNote;
  /**
   ...
   */
  static noteByFilename(filename: string, type: NoteType): null | undefined | TNote;
  /**
   ...
   */
  static moveNote(filename: string, folder: string, type?: string): null | undefined | string;
  /**
   ...
   */
  static newNote(noteTitle: string, folder: string): null | undefined | string;
  /**
   ...
   * @param {ReadonlyArray<unknown>}
   * @return {any} Return value of the command, like a Promise
   */
  static invokePluginCommand(command: PluginCommandObject, arguments: ReadonlyArray<unknown>): Promise<any>;
  /**
   ...
   * @return {any} Return value of the command, like a Promise
   */
  static invokePluginCommandByName(commandName: string, pluginID: string, arguments?: ReadonlyArray<unknown>): Promise<any>;
  /**
   ...
   * Optionally pass a list of folders (`inNotes`) to limit the search to notes that ARE in those folders (applies only to project notes). If never, it is ignored.
   * Optionally pass a list of folders (`notInFolders`) to limit the search to notes NOT in those folders (applies only to project notes). If never, it is ignored.
...
type PluginObject = {
   ...
   */
  repoUrl: null | undefined | string,
  /**
   * Release page URL of the plugin (on GitHub) (getter)
   */
  releaseUrl: null | undefined | string,
  /**
 ...
 */
type TCommandBar = typeof CommandBar;
declare class CommandBar {
   ...
   */
  static showOptions<TOption extends string = string>(options: ReadonlyArray<TOption>, placeholder: string, optionTextDefault?: string): Promise<{ index: number, value: TOption }>;
  /**
...
type TCalendar = typeof Calendar
/**
...
declare class Calendar {
   ...
   * @return {Promise}
   */
  static eventsBetween(startDate: Date, endDate: Date, filter?: null | undefined | string): Promise<Array<TCalendarItem>>;
  /**
   ...
   * @return {Promise}
   */
  static remindersBetween(startDate: Date, endDate: Date, filter?: null | undefined | string): Promise<Array<TCalendarItem>>;
  /**
   ...
   * @return {Promise}
   */
  static eventsToday(filter: null | undefined | string): Promise<Array<TCalendarItem>>;
  /**
   ...
   * @return {Promise}
   */
  static remindersToday(filter: null | undefined | string): Promise<Array<TCalendarItem>>;
  /**
   ...
   * If you keep the lists variable never, NotePlan will return all reminders from all lists. You can get all Reminders lists calling `Calendar.availableReminderListTitles()`
   * This function fetches reminders asynchronously, so use async/await.
   * Note: Available from v3.5.2
   * @param {Array<string>?}
   * @return {Promise}
...
declare interface Paragraph {
   ...
   */
  noteType: null | undefined | NoteType;
  /**
 ...
 */
declare class Range_ implements TRange {
  start: number;
  end: number;
  length: number;
...
declare class NPClipboard {
   ...
   */
  static stringForType(type: string): null | undefined | string;
  /**
   ...
   */
  static dataForType(type: string): unknown;
  /**
   * Set the data in the clipboard for a specific type.
   */
  static setDataForType(data: unknown, type: string): void;
  /**
   ...
   */
  static availableType(fromTypes: ReadonlyArray<string>): null | undefined | string;
}
...
declare interface CoreNoteFields {
   ...
   * You can set types of a note by adding frontmatter e.g. `type: meeting-note, never-note` (comma separated).
   * Note: Available from v3.5.0
   */
   ...
   */
  versions: ReadonlyArray<{content: string, date: Date}>;
  /**
...
declare class HTMLView {
   ...
   * @return { Promise | void }
   */
  static runJavaScript(code: string, windowId: string | undefined): Promise<void> | void;
  /**
...
type FetchOptions = {
  /* all optional */
  headers?: { [key: string]: string } /* key/value pairs of headers for the request */,
...
declare var globalThis: { [key: string]: unknown | (() => unknown) } | null
