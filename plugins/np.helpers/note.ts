...
import { getFolderListMinusExclusions, getFolderFromFilename } from '@np/helpers/folders'
import { displayTitle, type headingLevelType } from '@np/helpers/general'
import { toNPLocaleDateString } from '@np/helpers/NPdateTime'
import { findEndOfActivePartOfNote, findStartOfActivePartOfNote } from '@np/helpers/paragraph'
import { formRegExForUsersOpenTasks } from '@np/helpers/regex'
import { sortListBy } from '@np/helpers/sorting'
import { isOpen, isClosed, isDone, isScheduled } from '@np/helpers/utils'
 ...
 * @returns {boolean}
 */
export function isNoteFromAllowedFolder(note: TNote, folderList: Array<string>, allowAllCalendarNotes: boolean = true): boolean {
  // Calendar note check
