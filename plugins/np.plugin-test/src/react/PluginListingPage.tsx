...
function CommandTable({ commands, viewOption }: CommandTableProps): React.ReactNode {
  return (
 ...
 */
function PluginSection({ plugin, viewOption, index }: PluginSectionProps): React.ReactNode {
...
function PluginListingPage(props: Props): React.ReactNode {
