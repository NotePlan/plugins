...
import { convertNoteToFrontmatter } from '@np/helpers/NPnote' // Note: not the one in 'NPTemplating'
import { addTrigger, noteHasFrontMatter, setFrontMatterVars, TRIGGER_LIST } from '@np/helpers/NPFrontMatter'
// import { getParaFromContent, findStartOfActivePartOfNote } from '@np/helpers/paragraph'
import {
  chooseFolder,
  // chooseHeading,
