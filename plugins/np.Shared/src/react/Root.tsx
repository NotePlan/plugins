...
declare var globalSharedData: { [key: string]: any }
...
declare function sendMessageToPlugin(msg: Array<string | any>): void
...
import React, { useState, useEffect, Profiler, type ReactNode as Node, useRef } from 'react'
...
import { logDebug, formatReactError, JSP, clo, logError } from '@np/helpers/react/reactDev'
