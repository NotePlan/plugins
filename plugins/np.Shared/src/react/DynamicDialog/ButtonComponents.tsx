...
export const Button = ({ label, value, isDefault, disabled, onClick }: ButtonProps): React.ReactNode => {
...
export const ButtonGroup = ({ options, disabled, onClick, vertical }: ButtonGroupProps): React.ReactNode => {
  return (
