# cd.NotePlanBetaTester Changelog
...
## About cd.NotePlanBetaTester Plugin

See Plugin [README](https://github.com/NotePlan/plugins/blob/main/cd.NotePlanBetaTester/README.md) for details on available commands and use case.
