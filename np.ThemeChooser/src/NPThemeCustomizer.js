...
// no idea why "default" gets added to the JSON object at import, but it does
...
export async function createThemeSamples(idToScrollTo: string = '', autoRefreshRunning: boolean = false) {
  try {
    ...
    const defaultLight = DataStore.preference('themeLight')
    const defaultDark = DataStore.preference('themeDark')
