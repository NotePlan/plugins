  ...
  try {
    ...
    const testFormFields = [
      ...
      },
      {
        ...
        includeTeamspaceNotes: true,
        showValue: true,
        description: 'This note chooser filters notes by the folder selected in "Folder Chooser" above. Select a folder first, then this will show only notes in that folder.',
      },
      {
        type: 'note-chooser',
        ...
        includeTeamspaceNotes: true,
        showValue: true,
        description: 'This note chooser includes a "New Note" option to create notes. Click "➕ New Note" to create a new note.',
      },
      {
        type: 'note-chooser',
        ...
        includeTeamspaceNotes: true,
        showValue: true,
        description: 'This note chooser filters by folder AND allows creating new notes in that folder. Select a folder first, then you can create notes in that folder.',
      },
      {
