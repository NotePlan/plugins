...
export async function testFormFieldRender(): Promise<void> {
  try {
    ...
    const testFormFields = [
      ...
      {
        type: 'tag-chooser',
        label: 'Tag Chooser (String Format)',
        key: 'testTagChooser',
      ...
      {
        type: 'tag-chooser',
        label: 'Tag Chooser (Array Format)',
        key: 'testTagChooserArray',
        placeholder: 'Type to search hashtags...',
        description: 'Multi-select hashtag chooser. Returns array like ["#tag1", "#tag2"]',
        returnAsArray: true,
        defaultChecked: false,
      },
      {
        type: 'tag-chooser',
        label: 'Tag Chooser (Default Checked)',
        key: 'testTagChooserDefault',
        placeholder: 'Type to search hashtags...',
        description: 'Tag chooser with all items checked by default',
        returnAsArray: false,
        defaultChecked: true,
      },
      {
        type: 'mention-chooser',
        label: 'Mention Chooser (String Format)',
        key: 'testMentionChooser',
        placeholder: 'Type to search mentions...',
        description: 'Multi-select mention chooser. Returns comma-separated string like "@mention1,@mention2"',
        returnAsArray: false,
        defaultChecked: false,
      },
      {
        type: 'mention-chooser',
        label: 'Mention Chooser (Array Format)',
        key: 'testMentionChooserArray',
        placeholder: 'Type to search mentions...',
      ...
      {
        type: 'mention-chooser',
        label: 'Mention Chooser (Default Checked)',
        key: 'testMentionChooserDefault',
        placeholder: 'Type to search mentions...',
        description: 'Mention chooser with all items checked by default',
        returnAsArray: false,
        defaultChecked: true,
      },
      {
