# Note Protector Noteplan Plugin

## Latest Updates

See [CHANGELOG](https://github.com/NotePlan/plugins/blob/main/aaronpoweruser.NoteProtector/CHANGELOG.md) for latest updates/changes to this plugin.
