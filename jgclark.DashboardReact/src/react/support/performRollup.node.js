 ...
 * (builds development mode by default)
        node 'jgclark.DashboardReact/src/react/support/performRollup.node.js'
...
;(async function () {
  ...
  const rollupConfigs = [
    ...
    getRollupConfig({
      entryPointPath: 'jgclark.DashboardReact/src/react/support/rollup.WebView.entry.js',
      outputFilePath: 'jgclark.DashboardReact/requiredFiles/react.c.WebView.bundle.REPLACEME.js',
  ...
  await rollupReactFiles(config, watch, 'jgclark.DashboardReact: development && production')
