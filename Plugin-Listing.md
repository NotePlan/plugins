...
| `period` | Show stats of tags and mentions over a time period | 🔢 Note Statistics |
| `stats` | Show stats of tags and mentions over a time period | 🔢 Note Statistics |
| `count` | Show stats of tags and mentions over a time period | 🔢 Note Statistics |
| `strftime` | Insert custom formatted (format) date/time | 📅 Date Automations |
...
| `daily` | Apply Daily Note Template (requires configuring) | ☀️ Daily Journal |
| `template` | Apply Daily Note Template (requires configuring) | ☀️ Daily Journal |
...
| `daily` | Ask journal questions for an end-of-day review (requires configuring) | ☀️ Daily Journal |
| `journal` | Ask journal questions for an end-of-day review (requires configuring) | ☀️ Daily Journal |
| `review` | Ask journal questions for an end-of-day review (requires configuring) | ☀️ Daily Journal |
...
| `mp` | file (move) paragraphs to different notes | 🗃 Filer |
| `file` | file (move) paragraphs to different notes | 🗃 Filer |
| `now` | Insert (human readable) date+time at cursor | 📅 Date Automations |
| `move` | file (move) paragraphs to different notes | 🗃 Filer |
| `paragraph` | file (move) paragraphs to different notes | 🗃 Filer |
...
| `date` | Insert ISO-8601 date+time at cursor (e.g. 2021-08-06 17:20:11) | 📅 Date Automations |
| `gtd` | creates/updates a human-readable list of project notes, including basic tasks statistics and time until next review, and time until the project is due to complete. | 🔬Reviews |
| `list` | creates/updates a human-readable list of project notes, including basic tasks statistics and time until next review, and time until the project is due to complete. | 🔬Reviews |
...
| `gtd` | creates/updates a machine-readable list of notes ready for review, and kicks off review of the first project note | 🔬Reviews |
| `complete project` | add @completed(today) date to the open project | 🔬Reviews |
| `gtd` | add @completed(today) date to the open project | 🔬Reviews |
| `complete` | add @completed(today) date to the open project | 🔬Reviews |
| `finish project review` | updates the current open project's @reviewed() date | 🔬Reviews |
| `gtd` | updates the current open project's @reviewed() date | 🔬Reviews |
| `reviewed` | updates the current open project's @reviewed() date | 🔬Reviews |
| `8601` | Insert ISO-8601 date+time at cursor (e.g. 2021-08-06 17:20:11) | 📅 Date Automations |
| `next project review` | updates this project's @reviewed() date, and jump to next project to review | 🔬Reviews |
| `gtd` | updates this project's @reviewed() date, and jump to next project to review | 🔬Reviews |
| `review` | updates this project's @reviewed() date, and jump to next project to review | 🔬Reviews |
| `add project` | add a new note representing a project, asking for its metadata | 🔬Reviews |
| `gtd` | add a new note representing a project, asking for its metadata | 🔬Reviews |
| `project` | add a new note representing a project, asking for its metadata | 🔬Reviews |
| `new` | add a new note representing a project, asking for its metadata | 🔬Reviews |
| `apply template` | Choose a Template to apply (append) to the current Note | 🔩 Templates |
| `at` | Choose a Template to apply (append) to the current Note | 🔩 Templates |
| `append` | Choose a Template to apply (append) to the current Note | 🔩 Templates |
| `t` | Insert ISO-8601 date+time at cursor (e.g. 2021-08-06 17:20:11) | 📅 Date Automations |
| `template` | Choose a Template to apply (append) to the current Note | 🔩 Templates |
| `insert template` | Choose a Template to insert into the current Note | 🔩 Templates |
| `it` | Choose a Template to insert into the current Note | 🔩 Templates |
| `template` | Choose a Template to insert into the current Note | 🔩 Templates |
...
| `template` | Create new note with title, in chosen folder with optional template | 🔩 Templates |
...
| `test` | Simple plugin test to check that plugins are working for you | 🔌 Plugin Tester |
| `Plugin Test` | Simple plugin test to check that plugins are working for you | 🔌 Plugin Tester |
| `nc` | Counts of all the notes in NotePlan | 🔢 Note Statistics |
| `note` | Counts of all the notes in NotePlan | 🔢 Note Statistics |
| `stats` | Counts of all the notes in NotePlan | 🔢 Note Statistics |
| `count` | Counts of all the notes in NotePlan | 🔢 Note Statistics |
| `tsp` | Shows task statistics for project notes | 🔢 Note Statistics |
| `task` | Shows task statistics for project notes | 🔢 Note Statistics |
| `stats` | Shows task statistics for project notes | 🔢 Note Statistics |
| `dp` | (Date Picker) Choose format and insert date/time time at cursor | 📅 Date Automations |
| `count` | Shows task statistics for project notes | 🔢 Note Statistics |
| `tc` | Shows task counts for the current note | 🔢 Note Statistics |
| `task` | Shows task counts for the current note | 🔢 Note Statistics |
| `stats` | Shows task counts for the current note | 🔢 Note Statistics |
| `count` | Shows task counts for the current note | 🔢 Note Statistics |
| `wc` | Shows word count and other numbers for the note | 🔢 Note Statistics |
| `word` | Shows word count and other numbers for the note | 🔢 Note Statistics |
| `stats` | Shows word count and other numbers for the note | 🔢 Note Statistics |
| `count` | Shows word count and other numbers for the note | 🔢 Note Statistics |
