// to bundle:
/*
 npx rollup -c dwertheimer.React/requiredFiles/bundling/rollup.preact.cfg.js
*/
 ...
 */
const BUILD_MODE = 'development' // 'production'|'development' (will minify everything)
const entryPointFilename = 'dwertheimer.React/requiredFiles/bundling/rollup.preact.entry.js'
// IMPORTANT: end the file in JSX if you want it auto-loaded by the plugin as a component
const outputFilename = `dwertheimer.React/requiredFiles/_preactBundle${BUILD_MODE === 'production' ? '.min' : ''}.js`
const exportedFileVarName = 'preactRollupBundle' // needs to be unique for each bundle (but is never used)
