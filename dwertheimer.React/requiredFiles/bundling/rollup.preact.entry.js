...
// NOTE: this almost works. loads fast, but React-Select does not seem to work properly
/**
 ...
 **/
export * as Preact from 'preact/compat'
export * as React from 'preact/compat'
export * as reactDOM from 'preact/compat'
export * as react from 'preact/compat'
export * as reactDOMClient from 'preact/compat'
export * as ReactDOM from 'preact/compat'
