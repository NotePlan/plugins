...
;(function () {
  ...
  ;(function (c, x) {
      ...
      if (h)
        return (
          ...
          ca(d)
            ...
            : null != d && (M(d) && (d = na(d, e + (!d.key || (h && h.key === d.key) ? '' : ('' + d.key).replace(da, '$&/') + '/') + a)), b.push(d)),
          1
        )
      h = 0
      m = '' === m ? '.' : m + ':'
    ...
    c.createContext = function (a) {
      a = { $$typeof: va, _currentValue: a, _currentValue2: a, _threadCount: 0, Provider: null, Consumer: null, _defaultValue: null, _globalName: null }
