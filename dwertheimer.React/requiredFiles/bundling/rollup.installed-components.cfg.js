...
const entryPointFilename = 'dwertheimer.React/requiredFiles/bundling/rollup.installed-components.entry.js'
// IMPORTANT: end the file in JSX if you want it auto-loaded by the plugin as a component
const outputFilename = 'dwertheimer.React/requiredFiles/_installed-components.bundle.jsx' // .jsx will autoload as a component
const exportedFileVarName = 'rollupDataTableStyled' // needs to be unique for each bundle (but is never used)
const BUILD_MODE = 'development' // 'production'|'develoment' (will minify everything)
const externalModules = ['React', 'react'] // modules used by the bundle that you don't want rolled up into the bundle (and potentially duplicated by other bundles)
