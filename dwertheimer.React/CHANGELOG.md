# dwertheimer.React Changelog

## About dwertheimer.React Plugin

See Plugin [README](https://github.com/NotePlan/plugins/blob/main/dwertheimer.React/README.md) for details on available commands and use case.
