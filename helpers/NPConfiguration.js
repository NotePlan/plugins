...
/**
 * Returns the plugin object from a list of plugins generated by DataStore.installedPlugins()
 * that matches plugin id and optionally minVersion.
 * @param {Array<PluginObject>} list - array of plugins
 * @param {string} id - id to find
 * @param {string} minVersion - min version to find in semver ("x.y.z") format (optional)
 * @returns {boolean} plugin object
 */
export const findPluginInList = (list: Array<PluginObject>, id: string, minVersion?: string = '0.0.0'): any => {
  return list.find((p) => {
    if (p.id === id) {
      logDebug(
