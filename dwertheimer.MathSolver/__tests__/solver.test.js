  ...
  describe('helpers/solver' /* file */, () => {
    ...
    describe('parse' /* function */, () => {
      ...
      test('should work for x as % of a number', () => {
        ...
        const currentData = {info: [], variables: {}, relations: [], expressions: []}
        const result = s.parse(str,0,currentData)
        expect(result.variables['R0']).toEqual(.02)
      })
      test('should work for x as % of a number', () => {
      ...
      test('should assign variable', () => {
        ...
        const currentData = {
            info: [], variables: {}, relations: [], expressions: [], rows: 1
        }
        const result = s.parse(str,0,currentData)
      ...
      test('should add two lines properly', () => {
        ...
        const currentData = {"expressions": ["varname = 4 + 2"], "info": [{"row": 0, "typeOfResult": "A", "typeOfResultFormat": "N"}], "relations": [["varname"]], "variables": {"R0": 6, "varname": 6},"rows":2}
