...
AI agents: see root [`AGENTS.md`](AGENTS.md). There are  skills which live in 
[`agents/skills/`](agents/skills/), with tool-specific
symlinks under `.claude/skills/` and `.cursor/skills/`.
